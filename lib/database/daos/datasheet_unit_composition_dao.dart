...
class DatasheetUnitCompositionDao extends DatabaseAccessor<AppDatabase>
  ...
  Future<List<TdatasheetunitcompositionData>> getAll() =>
      select(tdatasheetunitcomposition).get();

  Future<List<TdatasheetunitcompositionData>> getByPK(
  ...
  Future<int> deleteByPK(int datasheetId, int line) => (delete(
  ...
  Future<List<models.DatasheetUnitComposition>> getAllModels() async {
    ...
    return data
        .map((c) => models.DatasheetUnitComposition(
