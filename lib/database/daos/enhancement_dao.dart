...
class EnhancementDao extends DatabaseAccessor<AppDatabase>
  ...
  Future<List<TenhancementData>> getEnhancementsByDetachment(
          int detachmentId) =>
      (select(tenhancement)..where((t) => t.detachmentId.equals(detachmentId)))
          .get();
